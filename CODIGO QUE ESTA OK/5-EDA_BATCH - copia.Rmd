...
```{r}
save(Datos_actualizados, file = "metadata_high_int.rda")
...
# 15. Kruskal wallis para detectar el peso de cada factor en el efecto batch. Propósito: Evaluar si las puntuaciones del PCA difieren significativamente entre los niveles de un factor (como PCR.Cov, fecha o equipo).
#Motivación: Kruskal-Wallis es una prueba no paramétrica que no asume normalidad, lo que la hace adecuada si los datos no pasan la prueba de Shapiro-Wilk.
...
#combat_corrected con feca y mod=equipo
