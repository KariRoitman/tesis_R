...
```{r}
test_subset <- test_subset[, colnames(trainData_equipo_dico)[1:25]]
#test_subset <-  test_subset[, colnames(trainData_equipo_dico)]
thr_filtered <-  thr[colnames(trainData_equipo_dico)[1:25]]
#Dicotimizacion de la matriz de intensidad
...
library(dplyr)
testData_equipo_dico<-as.data.frame(testData_equipo_dico)
testData_equipo_dico <- testData_equipo_dico %>% rename(Y = V26)
str(testData_equipo_dico$Y)
```
