...
```{r}
combat_corrected_equipo<-combat_corrected_equipo_tot[1:542,]

ciego_combat_corrected_equipo<-combat_corrected_equipo_tot[543:694,]
```
...
```{r}
combat_corrected_equipo_dic<-combat_corrected_equipo_tot[1:542,]

ciego_combat_corrected_equipo_dic<-combat_corrected_equipo_tot[543:694,]
```
...
split_data <- initial_split(combat_corrected_equipo_dic, strata = "label", prop = 0.8)
