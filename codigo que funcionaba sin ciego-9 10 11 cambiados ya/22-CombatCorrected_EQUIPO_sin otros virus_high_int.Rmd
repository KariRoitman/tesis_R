...
```{r}
combat_corrected_equipo_cc<- cbind(combat_corrected_equipo_cc, label=Datos_actualizados$PCR.Cov)#1=neg,2=pos
```

```{r}
combat_corrected_equipo_cc<-as.data.frame(combat_corrected_equipo_cc)
combat_corrected_equipo_cc$label<-as.factor(combat_corrected_equipo_cc$label)
str(combat_corrected_equipo_cc)
```
...
```{r}
library(dplyr)
combat_corrected_equipo_cc <- combat_corrected_equipo_cc %>% rename(Y = label)
str(combat_corrected_equipo_cc$Y)
```
...
split_data <- initial_split(combat_corrected_equipo_cc, strata = "Y", prop = 0.8)
...
split_data <- initial_split(combat_corrected_equipo_cc, strata = "label", prop = 0.8)
...
```{r}
test_subset <- test_subset[, colnames(trainData_equipo_dico)[1:34]]
#test_subset <-  test_subset[, colnames(trainData_equipo_dico)]
thr_filtered <-  thr[colnames(trainData_equipo_dico)[1:34]]
#Dicotimizacion de la matriz de intensidad
...
library(dplyr)
testData_equipo_dico<-as.data.frame(testData_equipo_dico)
testData_equipo_dico <- testData_equipo_dico %>% rename(Y = V35)
str(testData_equipo_dico$Y)
```
...
Ranger_metrics_equipo_cc <- caret::confusionMatrix(predRF_equipo_dico_CC, y_test, positive = "Cov.Pos")
```

```{r}
accuracyRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$overall["Accuracy"]
kappaRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$overall["Kappa"]
# Métricas por clase
sensitivityRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Sensitivity"]
specificityRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Specificity"]
precisionRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Pos Pred Value"]
recallRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Sensitivity"]  # Igual a sensitivity
f1_scoreRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["F1"]
npvRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Neg Pred Value"]
prevalenceRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Prevalence"]
detection_rateRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Detection Rate"]
balanced_accuracyRF_equipo_dic_cc <- Ranger_metrics_equipo_cc$byClass["Balanced Accuracy"]
...
```{r}
library(caret)
accuracyGLM_equipo_dic_cc <- RF_metrics_equipo$overall["Accuracy"]
kappaGLM_equipo_dic_cc <- RF_metrics_equipo$overall["Kappa"]
# Métricas por clase
sensitivityGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Sensitivity"]
specificityGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Specificity"]
precisionGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Pos Pred Value"]
recallGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Sensitivity"]  # Igual a sensitivity
f1_scoreGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["F1"]
npvGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Neg Pred Value"]
prevalenceGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Prevalence"]
detection_rateGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Detection Rate"]
balanced_accuracyGLM_equipo_dic_cc <- RF_metrics_equipo$byClass["Balanced Accuracy"]
...
# # Imprimir la matriz de confusión
# print(confusion_matrixKNN)
GLM_metrics_equipo <- caret::confusionMatrix(predKNN_equipo_dic_cc, y_test, positive = "Cov.Pos")
```
...
accuracyKNN_equipo_dic_CC <- GLM_metrics_equipo$overall["Accuracy"]
kappaKNN_equipo_dic_CC <- GLM_metrics_equipo$overall["Kappa"]
# Métricas por clase
sensitivityKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Sensitivity"]
specificityKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Specificity"]
precisionKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Pos Pred Value"]
recallKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Sensitivity"]  # Igual a sensitivity
f1_scoreKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["F1"]
npvKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Neg Pred Value"]
prevalenceKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Prevalence"]
detection_rateKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Detection Rate"]
balanced_accuracyKNN_equipo_dic_CC <- GLM_metrics_equipo$byClass["Balanced Accuracy"]
