...
```{r}
combat_corrected_fecha_solocovid_dic<-combat_corrected_fecha_covid[1:490,]

ciego_combat_corrected_fecha_solocovid_dic<-combat_corrected_fecha_covid[491:671,]
...
split_data <- initial_split(combat_corrected_fecha_solocovid_dic, strata = "label", prop = 0.8)
