...
```{r}
# combat_corrected_fecha_cc_nodico_tot<- cbind(combat_corrected_fecha_cc_tot, label=Datos_actualizados$PCR.Cov)#1=neg,2=pos
# 
# combat_corrected_fecha_cc_nodico_tot<-as.data.frame(combat_corrected_fecha_cc_nodico_tot)
# combat_corrected_fecha_cc_nodico_tot$label <- as.factor(combat_corrected_fecha_cc_nodico_tot$label)
# combat_corrected_fecha_cc_nodico_tot <- combat_corrected_fecha_cc_nodico_tot %>%
#   rename(Y = label)
```
