...
split_data <- initial_split(featureMatrix_bind, strata = "label", prop = 0.8)
...
```{r}
# Predicciones (clase)
predicciones_ciego_matrix_carga <- predict(RF, newdata = X_ciego)
levels(predicciones_ciego_matrix_carga) <- c("Cov.Neg", "Cov.Pos")

# Predicciones (probabilidades)
prob_ciego <- predict(RF, newdata = X_ciego, type = "prob")
prob_ciego <- prob_ciego %>%
  ...
  # Confusion matrix
  ciego_matrix_carga<-caret::confusionMatrix(predicciones_ciego_matrix_carga, Y_ciego, positive = "Cov.Pos")
