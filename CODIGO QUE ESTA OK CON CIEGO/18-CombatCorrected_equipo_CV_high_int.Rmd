...
combat_corrected_equipo_high<- cbind(combat_corrected_equipo_high, label=Datos_actualizados$PCR.Cov)#1=neg,2=pos
```

```{r}
combat_corrected_equipo_high<-as.data.frame(combat_corrected_equipo_high)
combat_corrected_equipo_high$label<-as.factor(combat_corrected_equipo_high$label)
...
str(combat_corrected_equipo_high_tot$Y)
```

```{r}
combat_corrected_equipo_high<-combat_corrected_equipo_high_tot[1:238,]

ciego_combat_corrected_equipo_high<-combat_corrected_equipo_high_tot[239:327,]
```
...
split_data <- initial_split(combat_corrected_equipo_high, strata = "Y", prop = 0.8)
...
#combat_corrected_equipo_high_tot<- cbind(combat_corrected_equipo_high_tot, label=Datos_actualizados$PCR.Cov)#1=neg,2=pos
combat_corrected_equipo_high_tot<-as.data.frame(combat_corrected_equipo_high_tot)
combat_corrected_equipo_high_tot$Y <- as.factor(combat_corrected_equipo_high_tot$Y)
```

```{r}
combat_corrected_equipo_high_dic<-combat_corrected_equipo_high_tot[1:238,]

ciego_combat_corrected_equipo_high_dic<-combat_corrected_equipo_high_tot[239:327,]
```
