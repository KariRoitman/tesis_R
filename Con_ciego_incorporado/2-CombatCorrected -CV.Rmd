...
split_data <- initial_split(combat_corrected_equipo_nodic_tot, strata = "Y", prop = 0.8)
...
# Crear un dataframe con todas las métricas
metrics_rf_equipo_ciego <- data.frame(
  Metric = c("Accuracy", "Kappa", "Sensitivity", "Specificity", "Precision", 
             "F1_Score", "NPV", "Prevalence", "Detection_Rate", 
             "Balanced_Accuracy", "LR+", "LR-", "AUC"),
...
metrics_RANGER_equipo_ciego <- data.frame(
  Metric = c("Accuracy", "Kappa", "Sensitivity", "Specificity", "Precision", 
             "F1_Score", "NPV", "Prevalence", "Detection_Rate", 
             "Balanced_Accuracy", "LR+", "LR-", "AUC"),
...
print(metrics_RANGER_equipo_ciego)  
```
...
split_data <- initial_split(combat_corrected_equipo_tot_dic, strata = "label", prop = 0.8)
...
```{r}
ciego_data_knn_dic <- as.data.frame(ciego_combat_corrected_equipo_tot_dic)
...
prob_ciego_knn_dic <- prob_ciego_knn_dic %>%
  ...
  # Confusion matrix
  ciego_tot_equipo_knn<-caret::confusionMatrix(predicciones_ciego_knn_dic, Y_ciego, positive = "Cov.Pos")
...
accuracyKNN_equipo_dic_ciego <- ciego_data_knn_dic$overall["Accuracy"]
kappaKNN_equipo_dic_ciego <- ciego_data_knn_dic$overall["Kappa"]
# Métricas por clase
sensitivityKNN_equipo_dic_ciego<- ciego_data_knn_dic$byClass["Sensitivity"]
specificityKNN_equipo_dic_ciego <- ciego_data_knn_dic$byClass["Specificity"]
precisionKNN_equipo_dic_ciego <- ciego_data_knn_dic$byClass["Pos Pred Value"]
recallKNN_equipo_dic_ciego<- ciego_data_knn_dic$byClass["Sensitivity"]  # Igual a sensitivity
f1_scoreKNN_equipo_dic_ciego <- ciego_data_knn_dic$byClass["F1"]
npvKNN_equipo_dic_ciego <- ciego_data_knn_dic$byClass["Neg Pred Value"]
prevalenceKNN_equipo_dic_ciego <- ciego_data_knn_dic$byClass["Prevalence"]
detection_rateKNN_equipo_dic_ciego <- ciego_data_knn_dic$byClass["Detection Rate"]
balanced_accuracyKNN_equipo_dic_ciego <- ciego_data_knn_dic$byClass["Balanced Accuracy"]
...
# Crear un dataframe con todas las métricas
metrics_KNN_dic_equipo_ciego <- data.frame(
  Metric = c("Accuracy", "Kappa", "Sensitivity", "Specificity", "Precision", 
             "F1_Score", "NPV", "Prevalence", "Detection_Rate", 
             "Balanced_Accuracy", "LR+", "LR-", "AUC"),
...
# Mostrar los resultados
print(metrics_KNN_dic_equipo_ciego)  
```
