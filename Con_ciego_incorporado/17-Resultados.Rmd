...
```{r}
# 
ciegos<-list(metrics_RANGER_equipo_ciego, metrics_KNN_dic_equipo_ciego, metrics_rf_matrix_rf_ciego, metrics_rf_equipo_ciego, metrics_rf_fecha_ciego, metricsRanger_matrix_dich_cc_ciego,metricsKNN_equipo_dic_cc_ciego, metricsRF_matrix_carga_ciego) %>%
  reduce(full_join, by = "Metric")
